...
public class testLogin {
	...
	@Test(priority=0)
	public void testValidLogin() {			// Valid Login test method, once logged in checks for the presence of "BookShelf" Logo and the first book shown in the Dashboard to validate a successful login.
